...
func (c *authClient) Registration(ctx context.Context, in *RegistrationRequiest, opts ...grpc.CallOption) (*RegistrationResponse, error) {
...
func (UnimplementedAuthServer) Registration(context.Context, *RegistrationRequiest) (*RegistrationResponse, error) {
...
func _Auth_Registration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Registration(ctx, req.(*RegistrationRequiest))
	}
	return interceptor(ctx, in, info, handler)
}

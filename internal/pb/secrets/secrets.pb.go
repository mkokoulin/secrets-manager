...
type SecretStatusResponse int32

const (
	SecretStatusResponse_OK     SecretStatusResponse = 0
	SecretStatusResponse_Failed SecretStatusResponse = 1
)

// Enum value maps for SecretStatusResponse.
var (
	SecretStatusResponse_name = map[int32]string{
		0: "OK",
		1: "Failed",
	}
	SecretStatusResponse_value = map[string]int32{
		"OK":     0,
		"Failed": 1,
	}
)

func (x SecretStatusResponse) Enum() *SecretStatusResponse {
	p := new(SecretStatusResponse)
	*p = x
	return p
}

func (x SecretStatusResponse) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SecretStatusResponse) Descriptor() protoreflect.EnumDescriptor {
	return file_secrets_proto_enumTypes[0].Descriptor()
}

func (SecretStatusResponse) Type() protoreflect.EnumType {
	return &file_secrets_proto_enumTypes[0]
}

func (x SecretStatusResponse) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SecretStatusResponse.Descriptor instead.
func (SecretStatusResponse) EnumDescriptor() ([]byte, []int) {
...
type CreateSecretResponse struct {
	...
	Status SecretStatusResponse `protobuf:"varint,1,opt,name=status,proto3,enum=secrets.SecretStatusResponse" json:"status,omitempty"`
}
...
func (x *CreateSecretResponse) GetStatus() SecretStatusResponse {
	if x != nil {
		return x.Status
	}
	return SecretStatusResponse_OK
}
...
type GetSecretResponse struct {
	...
	Secrets []*GetSecretResponse_Secret `protobuf:"bytes,2,rep,name=secrets,proto3" json:"secrets,omitempty"`
}
...
func (x *GetSecretResponse) GetSecrets() []*GetSecretResponse_Secret {
	if x != nil {
		return x.Secrets
	}
	return nil
...
type GetSecretResponse_Secret struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetSecretResponse_Secret) Reset() {
	*x = GetSecretResponse_Secret{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetSecretResponse_Secret) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSecretResponse_Secret) ProtoMessage() {}

func (x *GetSecretResponse_Secret) ProtoReflect() protoreflect.Message {
	mi := &file_secrets_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSecretResponse_Secret.ProtoReflect.Descriptor instead.
func (*GetSecretResponse_Secret) Descriptor() ([]byte, []int) {
	return file_secrets_proto_rawDescGZIP(), []int{4, 0}
}

func (x *GetSecretResponse_Secret) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetSecretResponse_Secret) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *GetSecretResponse_Secret) GetMetaData() string {
	if x != nil {
		return x.MetaData
	}
	return ""
...
func (x *GetSecretResponse_Secret) GetData() []*Data {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_secrets_proto_rawDesc = []byte{
	...
	0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x4d, 0x0a, 0x14, 0x43, 0x72,
	...
	0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x2e, 0x53, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x2f, 0x0a, 0x10, 0x47, 0x65, 0x74,
	...
	,
	...
	0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x22, 0x32, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x65, 0x63,
	...
	0x65, 0x64, 0x10, 0x01, 0x2a, 0x2a, 0x0a, 0x14, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x06, 0x0a, 0x02,
...
var file_secrets_proto_goTypes = []interface{}{
	(SecretStatusResponse)(0),                    // 0: secrets.SecretStatusResponse
	(DeleteSecretResponse_DeleteSecretStatus)(0), // 1: secrets.DeleteSecretResponse.DeleteSecretStatus
	(*Data)(nil),                     // 2: secrets.Data
	(*CreateSecretRequest)(nil),      // 3: secrets.CreateSecretRequest
	(*CreateSecretResponse)(nil),     // 4: secrets.CreateSecretResponse
	...
	(*GetSecretResponse_Secret)(nil), // 9: secrets.GetSecretResponse.Secret
}
var file_secrets_proto_depIdxs = []int32{
	2, // 0: secrets.CreateSecretRequest.data:type_name -> secrets.Data
	0, // 1: secrets.CreateSecretResponse.status:type_name -> secrets.SecretStatusResponse
	9, // 2: secrets.GetSecretResponse.secrets:type_name -> secrets.GetSecretResponse.Secret
	1, // 3: secrets.DeleteSecretResponse.status:type_name -> secrets.DeleteSecretResponse.DeleteSecretStatus
	2, // 4: secrets.GetSecretResponse.Secret.data:type_name -> secrets.Data
	3, // 5: secrets.Secrets.CreateSecret:input_type -> secrets.CreateSecretRequest
	...
	4, // 8: secrets.Secrets.CreateSecret:output_type -> secrets.CreateSecretResponse
	6, // 9: secrets.Secrets.GetSecret:output_type -> secrets.GetSecretResponse
	8, // 10: secrets.Secrets.DeleteSecret:output_type -> secrets.DeleteSecretResponse
...
func file_secrets_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_secrets_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSecretResponse_Secret); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
